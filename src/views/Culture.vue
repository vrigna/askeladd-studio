<template>
  <div :style="askeladdBackground" class="d-flex flex-column justify-content-center bg-light" id="culture">
...
export default {
    ...
    data(){
        return{
            ...
            askeladdBackground: `background-image: url(${askeladdBackground})`,
        }
    },
