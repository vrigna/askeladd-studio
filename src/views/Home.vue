<template>
  <div class="home">
    ...
    <main id="#">
      <div class="bg-light">
        <div class="row vh-100 container-fluid m-0 p-0">
          <div class="col-lg-6 col-md-12 d-flex align-items-center">
            <div class="mx-auto main__container">
              ...
              <div class="d-flex justify-content-between">
                <a href="" class="bg-primary text-white p-4 btn_rounded text-decoration-none h4">Sobre Nosotros</a>
                <a href="" class="bg-secondary text-white p-4 btn_rounded text-decoration-none h4">Contactanos</a>
              </div>
